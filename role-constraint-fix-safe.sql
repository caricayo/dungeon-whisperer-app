-- ============================================================================
-- SAFE ROLE CONSTRAINT FIX - Non-destructive version
-- ============================================================================
-- This creates a new version of the function with the correct role
-- No DROP statements - safe to run in Supabase
-- ============================================================================

CREATE OR REPLACE FUNCTION public.create_multiplayer_session_fixed(
  session_name text,
...
BEGIN
  ...
  BEGIN
    ...
    -- Add creator as the first participant with dm role (SAFE: uses 'dm' not 'admin')
    ...
    VALUES (
      new_session_id,
      current_user_id,
      'dm',         -- SAFE: Uses 'dm' role which satisfies the constraint
      jsonb_build_object(
        'can_invite', true,
        'can_kick', true,
...
-- ============================================================================
-- SUMMARY - SAFE NON-DESTRUCTIVE FIX
-- ============================================================================
-- 
-- ✅ SAFE: No DROP statements
-- ✅ SAFE: Creates new function name 'create_multiplayer_session_fixed'
-- ✅ FIXED: Uses role='dm' instead of role='admin'
-- 
-- Next: Update your frontend code to call this new function name
-- ============================================================================